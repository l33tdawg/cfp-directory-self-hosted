...
const cardGradients = [
  { bg: 'from-violet-500/10 to-fuchsia-500/10', border: 'group-hover:border-violet-500/30', glow: 'from-violet-500/30 to-fuchsia-500/30' },
  { bg: 'from-cyan-500/10 to-blue-500/10', border: 'group-hover:border-cyan-500/30', glow: 'from-cyan-500/30 to-blue-500/30' },
  { bg: 'from-emerald-500/10 to-teal-500/10', border: 'group-hover:border-emerald-500/30', glow: 'from-emerald-500/30 to-teal-500/30' },
  { bg: 'from-orange-500/10 to-rose-500/10', border: 'group-hover:border-orange-500/30', glow: 'from-orange-500/30 to-rose-500/30' },
];
        ...
        return (
          <Link key={event.id} href={`/e/${event.slug}`} className="group block">
            ...
            <div className="relative h-full">
              ...
              {/* Card */}
              <div className={`relative h-full p-6 rounded-2xl bg-slate-900/60 backdrop-blur-xl border border-white/10 ${gradient.border} transition-all duration-300 group-hover:bg-slate-900/80 ${isPast ? 'opacity-60' : ''}`}>
                <div className="flex gap-5">
                  {/* Event Icon */}
                  <div className={`flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br ${gradient.bg} border border-white/10 flex items-center justify-center group-hover:scale-105 transition-transform duration-300`}>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      ...
                      {event.isVirtual && (
                        <Badge className="text-xs bg-white/5 text-white/50 border border-white/10">
                    ...
                    {/* Title */}
                    <h3 className="font-semibold text-lg text-white group-hover:text-white/90 transition-colors line-clamp-2 mb-2">
                      {event.name}
                    </h3>
                  ...
                  <div className="flex-shrink-0 self-center">
                    <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-white/10 transition-all">
                      <ArrowRight className="h-5 w-5 text-white/30 group-hover:text-white/60 group-hover:translate-x-0.5 transition-all" />
                    </div>
                  </div>
                </div>
              </div>
