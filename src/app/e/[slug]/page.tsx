    ...
    <div className="min-h-screen flex flex-col bg-slate-100 dark:bg-slate-950">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-slate-200 dark:border-white/10">
        ...
        <div className="relative container mx-auto px-4 h-16 flex items-center justify-between">
          <Link 
            href="/" 
            className="inline-flex items-center gap-2 text-slate-600 dark:text-white/70 hover:text-slate-900 dark:hover:text-white transition-colors group"
          >
        ...
        <section className="relative min-h-[50vh] flex items-center overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 py-16 md:py-24">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {isCfpOpen && (
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20">
                    ...
                    <span className="text-sm font-medium text-emerald-600 dark:text-emerald-400">CFP Open</span>
                  </div>
                )}
                {isCfpUpcoming && (
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20">
                    <Clock className="h-4 w-4 text-blue-600 dark:text-blue-400" />
                    <span className="text-sm font-medium text-blue-600 dark:text-blue-400">CFP Opens Soon</span>
                  </div>
                )}
                {isCfpClosed && (
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900/5 dark:bg-white/5 border border-slate-900/10 dark:border-white/10">
                    <span className="text-sm font-medium text-slate-500 dark:text-white/60">CFP Closed</span>
                  </div>
                )}
                {event.isVirtual && (
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/10 border border-violet-500/20">
                    <Globe className="h-4 w-4 text-violet-600 dark:text-violet-400" />
                    <span className="text-sm font-medium text-violet-600 dark:text-violet-400">Virtual Event</span>
                  </div>
                )}
              </div>
              ...
              {/* Key Info Row */}
              <div className="flex flex-wrap gap-6 text-slate-600 dark:text-white/70 mb-8">
                {startDate && (
        ...
        {isCfpOpen && cfpClosesAt && (
          <div className={`py-4 px-4 text-center font-medium ${
            daysUntilClose !== null && daysUntilClose <= 7 
              ? 'bg-gradient-to-r from-orange-500/20 to-rose-500/20 border-y border-orange-500/20 text-orange-600 dark:text-orange-400' 
              : 'bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border-y border-emerald-500/20 text-emerald-600 dark:text-emerald-400'
          }`}>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                {event.description && (
                  <div className="group relative">
                    ...
                    <div className="relative p-6 rounded-2xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200 dark:border-white/10 group-hover:border-slate-300 dark:group-hover:border-white/20 transition-all">
                      ...
                      <div 
                        className="prose prose-slate dark:prose-invert prose-violet max-w-none text-slate-600 dark:text-white/70 prose-headings:text-slate-900 dark:prose-headings:text-white prose-strong:text-slate-900 dark:prose-strong:text-white prose-a:text-violet-600 dark:prose-a:text-violet-400"
                  ...
                  <div className="group relative">
                    ...
                    <div className="relative p-6 rounded-2xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200 dark:border-white/10 group-hover:border-slate-300 dark:group-hover:border-white/20 transition-all">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                          <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Submission Guidelines</h2>
                          <p className="text-sm text-slate-500 dark:text-white/50">Please review before submitting your proposal</p>
                        </div>
                      </div>
                      {/* SECURITY: Sanitize HTML to prevent XSS */}
                      <div 
                        className="prose prose-slate dark:prose-invert prose-cyan max-w-none text-slate-600 dark:text-white/70 prose-headings:text-slate-900 dark:prose-headings:text-white prose-strong:text-slate-900 dark:prose-strong:text-white prose-a:text-cyan-600 dark:prose-a:text-cyan-400 mt-4"
                  ...
                  <div className="group relative">
                    ...
                    <div className="relative p-6 rounded-2xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200 dark:border-white/10 group-hover:border-slate-300 dark:group-hover:border-white/20 transition-all">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                          <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Speaker Benefits</h2>
                          <p className="text-sm text-slate-500 dark:text-white/50">What we offer to our speakers</p>
                        </div>
                      </div>
                      {/* SECURITY: Sanitize HTML to prevent XSS */}
                      <div 
                        className="prose prose-slate dark:prose-invert prose-emerald max-w-none text-slate-600 dark:text-white/70 prose-headings:text-slate-900 dark:prose-headings:text-white prose-strong:text-slate-900 dark:prose-strong:text-white prose-a:text-emerald-600 dark:prose-a:text-emerald-400 mt-4"
                  ...
                  <div className="group relative">
                    ...
                    <div className="relative p-6 rounded-2xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200 dark:border-white/10 group-hover:border-slate-300 dark:group-hover:border-white/20 transition-all">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Tracks</h2>
                          <p className="text-sm text-slate-500 dark:text-white/50">Submit your talk to one of these tracks</p>
                        </div>
                      </div>
                      <div className="grid sm:grid-cols-2 gap-3">
                        {event.tracks.map((track) => (
                          <div 
                            key={track.id}
                            className="p-4 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-slate-300 dark:hover:border-white/20 transition-all"
                            style={{ borderLeftColor: track.color || undefined, borderLeftWidth: track.color ? '3px' : undefined }}
                          >
                            <h4 className="font-medium text-slate-900 dark:text-white">{track.name}</h4>
                            {track.description && (
                              <p className="text-sm text-slate-500 dark:text-white/50 mt-1">{track.description}</p>
                            )}
                          </div>
                        ))}
                      </div>
                  ...
                  <div className="group relative">
                    ...
                    <div className="relative p-6 rounded-2xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200 dark:border-white/10 group-hover:border-slate-300 dark:group-hover:border-white/20 transition-all">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Session Formats</h2>
                          <p className="text-sm text-slate-500 dark:text-white/50">Available presentation formats</p>
                        </div>
                      </div>
                      <div className="grid sm:grid-cols-2 gap-3">
                        {event.formats.map((fmt) => (
                          <div 
                            key={fmt.id}
                            className="p-4 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-slate-300 dark:hover:border-white/20 transition-all flex items-center justify-between"
                          >
                            <h4 className="font-medium text-slate-900 dark:text-white">{fmt.name}</h4>
                            {fmt.durationMin && (
                              <Badge className="bg-slate-100 dark:bg-white/10 text-slate-600 dark:text-white/70 border border-slate-200 dark:border-white/10 hover:bg-slate-200 dark:hover:bg-white/20">
                                {fmt.durationMin} min
                              </Badge>
                            )}
                          </div>
              ...
              <div className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <div className="relative p-6 rounded-2xl bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200 dark:border-white/10">
                    <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-5">Event Details</h3>
                    ...
                    <div className="space-y-5">
                      ...
                      {startDate && (
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <p className="font-medium text-slate-900 dark:text-white">{formatDateRange(startDate, endDate)}</p>
                            <p className="text-sm text-slate-500 dark:text-white/50">Event Date</p>
                          </div>
                        </div>
                      )}
                        ...
                        <>
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <p className="font-medium text-slate-900 dark:text-white">CFP Timeline</p>
                              <div className="text-sm text-slate-500 dark:text-white/50 mt-1 space-y-1">
                                <p className="flex justify-between">
                                  <span>Opens:</span>
                                  <span className="text-slate-600 dark:text-white/70">{format(cfpOpensAt, 'MMM d, yyyy')}</span>
                                </p>
                                <p className="flex justify-between">
                                  <span>Closes:</span>
                                  <span className="text-slate-600 dark:text-white/70">{format(cfpClosesAt, 'MMM d, yyyy')}</span>
                                </p>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-medium text-slate-900 dark:text-white">{event._count.submissions} Submissions</p>
                          <p className="text-sm text-slate-500 dark:text-white/50">Received so far</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {isCfpUpcoming && cfpOpensAt && (
                  <div className="relative">
                    ...
                    <div className="relative p-6 rounded-2xl bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-blue-500/20">
                      <div className="text-center">
                        <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-blue-500/20 flex items-center justify-center">
                          <Clock className="h-8 w-8 text-blue-600 dark:text-blue-400" />
                        </div>
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">CFP Opens Soon</h3>
                        <p className="text-slate-500 dark:text-white/50 mb-2">Submissions open on</p>
                        <p className="text-lg font-semibold bg-gradient-to-r from-blue-600 to-cyan-600 dark:from-blue-400 dark:to-cyan-400 bg-clip-text text-transparent">
                ...
                {isCfpClosed && (
                  <div className="relative">
                    <div className="relative p-6 rounded-2xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200 dark:border-white/10">
                      <div className="text-center">
                        <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-slate-100 dark:bg-white/5 flex items-center justify-center">
                          <Sparkles className="h-8 w-8 text-slate-400 dark:text-white/40" />
                        </div>
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">CFP Closed</h3>
                        <p className="text-slate-500 dark:text-white/50">Submissions are no longer accepted for this event.</p>
                      </div>
                    </div>
                  </div>
                )}
